...
\framesubtitle{In Ruby and Rails}
   ...
   \mintinline{ruby}{Date}, \mintinline{ruby}{DateTime} and \mintinline{ruby}{Time} 
    are Ruby classes.\footnote{Ruby Docs for \href{https://docs.ruby-lang.org/en/3.2/Date.html}{\mintinline{ruby}{Date}}, \href{https://docs.ruby-lang.org/en/3.2/DateTime.html}{\mintinline{ruby}{DateTime}} and \href{https://docs.ruby-lang.org/en/3.2/Time.html}{\mintinline{ruby}{Time}}}
...
\begin{frame}[standout]
  \centering\large
  \mintinline{ruby}{DateTime} acts like a date and a time, so that must be the best one, if I want to give a date and a time, right?
...
\framesubtitle{Prefer Time to DateTime}
  ...
  \end{frame}
   ...
   \begin{frame}
\frametitle{DateTime vs. Time}
\framesubtitle{\normalsize Except when you prefer DateTime}

  
Current (3.4) Ruby Docs still say that \mintinline{ruby}{DateTime} is preferable to  \mintinline{ruby}{Time} for \textbf{historical} dates.
...
\mintinline{ruby}{Time.current} is slightly superior, in that it also handles a scenario where somehow \mintinline{ruby}{Time.zone} is  \mintinline{ruby}{nil}\footnote{See \href{https://github.com/rails/rails/blob/v8.1.1/activesupport/lib/active_support/core_ext/time/calculations.rb\#L39}{definition of  \mintinline{ruby}{current}}}
...
It can be helpful to think of there being 4 main kinds of time/ time zones\footnote{I first saw these 4 in this \href{https://thoughtbot.com/blog/its-about-time-zones}{thoughtbot article} but I've also looked into Rails docs to find info which backs this all up}
\end{frame}
...
\item  An instance of \mintinline{ruby}{TimeWithZone} (without zone specified) had the default, PST,  \mintinline{ruby}{zone}
\end{itemize}
